...
if true then
	...
	elseif v >= 5 and v <= 8 then
		vocText = "- ED"
	elseif v >= 9 and v <= 12 then
		vocText = "- RP"
	elseif v >= 13 and v <= 16 then
		vocText = "- EK"
	elseif v >= 17 and v <= 20 then
		vocText = "- DWARF"
	elseif v >= 21 and v <= 26 then
		vocText = "- ORC"
	elseif v >= 35 and v <= 39 then
		vocText = "- ELF"
	end
  ...
  onTextMessage(function(mode, text)
    ...
    if #re ~= 0 then
        ...
        if text:lower():find("sorcerer") then
            voc = "MS"
        elseif text:lower():find("master sorcerer") then
            voc = "MS"
		elseif text:lower():find("archmage") then
            voc = "MS"
		elseif text:lower():find("arcane wizard") then
            voc = "MS"
		elseif text:lower():find("druid") then
            voc = "ED"
		elseif text:lower():find("elder druid") then
            voc = "ED"
		elseif text:lower():find("celtic druid") then
            voc = "ED"
		elseif text:lower():find("spirit healer") then
            voc = "ED"
		elseif text:lower():find("archer") then
            voc = "RP"
		elseif text:lower():find("royal archer") then
            voc = "RP"
        elseif text:lower():find("medieval archer") then
            voc = "RP"
        elseif text:lower():find("executioner") then
            voc = "RP"
		elseif text:lower():find("knight") then
            voc = "EK"
		elseif text:lower():find("elite knight") then
            voc = "EK"
        elseif text:lower():find("templar knight") then
            voc = "EK"
        elseif text:lower():find("chaos knight") then
            voc = "EK"
		elseif text:lower():find("dwarf") then
            voc = "DWARF"
		elseif text:lower():find("dwarf blacksmith") then
            voc = "DWARF"
        elseif text:lower():find("dwarf weaponsmith") then
            voc = "DWARF"
        elseif text:lower():find("dwarf artisan") then
            voc = "DWARF"
		elseif text:lower():find("orc") then
            voc = "ORC"
		elseif text:lower():find("orc warrior") then
            voc = "ORC"
        elseif text:lower():find("orc berserker") then
            voc = "ORC"
        elseif text:lower():find("orc leader") then
            voc = "ORC"
		elseif text:lower():find("orc warlord") then
            voc = "ORC"
		elseif text:lower():find("orc general") then
            voc = "ORC"
        elseif text:lower():find("elf") then
            voc = "ELF"
        elseif text:lower():find("elf ranger") then
            voc = "ELF"
        elseif text:lower():find("elf sentinel") then
            voc = "ELF"
        elseif text:lower():find("high elf") then
            voc = "ELF"
        elseif text:lower():find("elven elite") then
            voc = "ELF"
        end

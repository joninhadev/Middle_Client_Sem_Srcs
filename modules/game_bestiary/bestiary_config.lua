...
Bestiary.categoriesDisplay = {
	...
	{id = 1, name = "Amphibic", display = {card = "images/cards/Amphibic"}},
	{id = 2, name = "Aquatic", display = {card = "images/cards/Aquatic"}},
	{id = 3, name = "Birds", display = {card = "images/cards/Bird"}},
	{id = 4, name = "Construct", display = {card = "images/cards/Construct"}},
	{id = 5, name = "Demons", display = {card = "images/cards/Demon"}},
	{id = 6, name = "Dragons", display = {card = "images/cards/Dragon"}},
	{id = 7, name = "Elementals", display = {card = "images/cards/Elemental"}},
	{id = 8, name = "Extra Dimensionals", display = {card = "images/cards/Extra_Dimensional"}},
	{id = 9, name = "Giants", display = {card = "images/cards/Giant"}},
	{id = 10, name = "Humans", display = {card = "images/cards/Human"}},
	{id = 11, name = "Humanoids", display = {card = "images/cards/Humanoid"}},
	{id = 12, name = "Lycanthropes", display = {card = "images/cards/Lycanthrope"}},
	{id = 13, name = "Magical Creatures", display = {card = "images/cards/Magical"}},
	{id = 14, name = "Mammals", display = {card = "images/cards/Mammal"}},
	{id = 15, name = "Plants", display = {card = "images/cards/Plant"}},
	{id = 16, name = "Reptiles", display = {card = "images/cards/Reptile"}},
	{id = 17, name = "Slimes", display = {card = "images/cards/Slime"}},
	{id = 18, name = "Undead", display = {card = "images/cards/Undead"}},
	{id = 19, name = "Vermin", display = {card = "images/cards/Vermin"}},
